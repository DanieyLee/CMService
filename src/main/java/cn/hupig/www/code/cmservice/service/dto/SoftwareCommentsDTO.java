...
/**
 * A DTO for the {@link cn.hupig.www.code.cmservice.domain.SoftwareComments} entity.
 */
public class SoftwareCommentsDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SoftwareCommentsDTO)) {
            return false;
        }

        return id != null && id.equals(((SoftwareCommentsDTO) o).id);
    }
