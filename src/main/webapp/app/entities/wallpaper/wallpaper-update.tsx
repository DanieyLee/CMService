...
import { getEntity, updateEntity, createEntity, reset } from './wallpaper.reducer';
import { IWallpaper } from 'app/shared/model/wallpaper.model';
import { convertDateTimeFromServer, convertDateTimeToServer, displayDefaultDateTime } from 'app/shared/util/date-utils';
import { mapIdList } from 'app/shared/util/entity-utils';

export interface IWallpaperUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const WallpaperUpdate = (props: IWallpaperUpdateProps) => {
  ...
  const handleClose = () => {
    props.history.push('/wallpaper' + props.location.search);
  };
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : wallpaperEntity} onSubmit={saveEntity}>
              ...
              <Button tag={Link} id="cancel-save" to="/wallpaper" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(WallpaperUpdate);
