...
import { getEntity } from './key-box.reducer';
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/key-box" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/key-box/${keyBoxEntity.id}/edit`} replace color="primary">
