...
import { getEntity, deleteEntity } from './article-type.reducer';

export interface IArticleTypeDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const ArticleTypeDeleteDialog = (props: IArticleTypeDeleteDialogProps) => {
  useEffect(() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ArticleTypeDeleteDialog);
