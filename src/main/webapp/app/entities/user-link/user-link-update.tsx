...
export interface IUserLinkUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const UserLinkUpdate = (props: IUserLinkUpdateProps) => {
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : userLinkEntity} onSubmit={saveEntity}>
              ...
              <Button tag={Link} id="cancel-save" to="/user-link" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(UserLinkUpdate);
