...
import { getEntities, reset } from './software-type.reducer';
import { ISoftwareType } from 'app/shared/model/software-type.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';
import { overridePaginationStateWithQueryParams } from 'app/shared/util/entity-utils';

export interface ISoftwareTypeProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export const SoftwareType = (props: ISoftwareTypeProps) => {
  ...
  return (
    <div>
      <h2 id="software-type-heading">
        <Translate contentKey="cmServiceApp.softwareType.home.title">Software Types</Translate>
            ...
            <Table responsive>
              ...
              <tbody>
                {softwareTypeList.map((softwareType, i) => (
                  <tr key={`entity-${i}`}>
                    <td>
                      <Button tag={Link} to={`${match.url}/${softwareType.id}`} color="link" size="sm">
                        {softwareType.id}
                      </Button>
                    </td>
                    ...
                    <td className="text-right">
                      <div className="btn-group flex-btn-group-container">
                        <Button tag={Link} to={`${match.url}/${softwareType.id}`} color="info" size="sm">
...
export default connect(mapStateToProps, mapDispatchToProps)(SoftwareType);
