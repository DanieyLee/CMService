...
import { getEntity, updateEntity, createEntity, reset } from './software-type.reducer';
import { ISoftwareType } from 'app/shared/model/software-type.model';
import { convertDateTimeFromServer, convertDateTimeToServer, displayDefaultDateTime } from 'app/shared/util/date-utils';
import { mapIdList } from 'app/shared/util/entity-utils';

export interface ISoftwareTypeUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const SoftwareTypeUpdate = (props: ISoftwareTypeUpdateProps) => {
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : softwareTypeEntity} onSubmit={saveEntity}>
              ...
              <Button tag={Link} id="cancel-save" to="/software-type" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(SoftwareTypeUpdate);
