...
export class Page extends JhiPagination {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <div  className="content-currency-page">
        <Pagination>
          <PaginationItem {...activePage === 1 && { disabled: true }}>
            <PaginationLink previous onClick={this.previousPage} href="javascript:void(0)">◁</PaginationLink>
          </PaginationItem>
          ...
          <PaginationItem {...activePage === maxPage && { disabled: true }}>
            <PaginationLink next onClick={this.nextPage} href="javascript:void(0)">▷</PaginationLink>
          </PaginationItem>
        </Pagination>
      </div>
    );
